...
function getThisWeekDate(dayIndex, hour, minute) {
  const today = new Date();
  const day = today.getDate() - today.getDay() + dayIndex; // 0 = Sunday
  const date = new Date(today.setDate(day));
  date.setHours(hour);
...
export const calendarEvents = [
  {
    title: "Math - Mr. Roy",
     start: getThisWeekDate(1, 8, 0),  // Monday 8:00 AM
    end: getThisWeekDate(1, 8, 45),
  },
  {
    title: "English - Ms. Anne",
    start: getThisWeekDate(1, 9, 0),
    end: getThisWeekDate(1, 9, 45),
  },
  {
    title: "Physics - Mr. Das",
    start: new Date(2024, 7, 12, 10, 0),
    end: new Date(2024, 7, 12, 10, 45),
  },
  {
    title: "History - Ms. Rose",
    start: new Date(2024, 7, 12, 11, 0),
    end: new Date(2024, 7, 12, 11, 45),
  },
  {
    title: "Biology - Mr. Sam",
  ...
  {
    title: "Biology - Mr. Sam",
    start: new Date(2024, 7, 13, 13, 0),
    end: new Date(2024, 7, 13, 13, 45),
  },
  ...
  {
    title: "English - Ms. Anne",
    start: new Date(2024, 7, 14, 9, 0),
    end: new Date(2024, 7, 14, 9, 45),
  },
  {
    title: "Math - Mr. Roy",
  ...
  {
    title: "Geography - Mr. Alan",
    start: new Date(2024, 7, 14, 11, 0),
    end: new Date(2024, 7, 14, 11, 45),
  },
  {
    title: "Commerce - Ms. Priya",
  ...
  {
    title: "Biology - Mr. Sam",
    start: new Date(2024, 7, 15, 8, 0),
    end: new Date(2024, 7, 15, 8, 45),
  },
  {
    title: "Chemistry - Ms. Tara",
