...
const AppTopbar = (0, react_1.forwardRef)((props, ref) => {
    ...
    const topbarmenuRef = (0, react_1.useRef)(null);
    const topbarmenubuttonRef = (0, react_1.useRef)(null);
    ...
    return (<div className="layout-topbar">
            <link_1.default href="/" className="layout-topbar-logo">
            ...
            <div ref={topbarmenuRef} className={(0, utils_1.classNames)('layout-topbar-menu', { 'layout-topbar-menu-mobile-active': layoutState.profileSidebarVisible })}>
