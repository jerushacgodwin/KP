...
const BlockViewer_1 = __importDefault(require("../../../demo/components/BlockViewer"));
const Free = () => {
...
<div className="surface-0 p-4 shadow-2 border-round">
    ...
    `;
    return (<>
            <BlockViewer_1.default header="Hero" code={block1} free>
                <div className="grid grid-nogutter surface-0 text-800">
                    <div className="col-12 md:col-6 p-6 text-center md:text-left flex align-items-center ">
                        <section>
                            <span className="block text-6xl font-bold mb-1">Create the screens</span>
                            ...
                            <button_1.Button label="Learn More" type="button" className="mr-3 p-button-raised"/>
                            <button_1.Button label="Live Demo" type="button" className="p-button-outlined"/>
                        </section>
                    </div>
                    <div className="col-12 md:col-6 overflow-hidden">
                        <img src="/demo/images/blocks/hero/hero-1.png" alt="hero-1" className="md:ml-auto block md:h-full" style={{ clipPath: 'polygon(8% 0, 100% 0%, 100% 100%, 0 100%)' }}/>
            ...
            </BlockViewer_1.default>

            <BlockViewer_1.default header="Feature" code={block2} containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8" free>
                <div className="surface-0 text-center">
                    <div className="mb-3 font-bold text-3xl">
                        <span className="text-900">One Product, </span>
                        <span className="text-blue-600">Many Solutions</span>
            ...
            <BlockViewer_1.default header="Pricing" code={block3} containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8" free>
                <div className="surface-0">
                    <div className="text-900 font-bold text-6xl mb-4 text-center">Pricing Plans</div>
                    <div className="text-700 text-xl mb-6 text-center line-height-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit numquam eligendi quos.</div>
                        ...
                        <div className="col-12 lg:col-4">
                            <div className="p-3 h-full">
                                <div className="shadow-2 p-3 h-full flex flex-column" style={{ borderRadius: '6px' }}>
                                    ...
                                    <hr className="mb-3 mx-0 border-top-1 border-bottom-none border-300 mt-auto"/>
                                    <button_1.Button label="Buy Now" className="p-3 w-full mt-auto"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 lg:col-4">
                            <div className="p-3 h-full">
                                <div className="shadow-2 p-3 h-full flex flex-column" style={{ borderRadius: '6px' }}>
                                    ...
                                    <hr className="mb-3 mx-0 border-top-1 border-bottom-none border-300"/>
                                    <button_1.Button label="Buy Now" className="p-3 w-full"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 lg:col-4">
                            <div className="p-3 h-full">
                                <div className="shadow-2 p-3 flex flex-column" style={{ borderRadius: '6px' }}>
                                    ...
                                    <hr className="mb-3 mx-0 border-top-1 border-bottom-none border-300"/>
                                    <button_1.Button label="Buy Now" className="p-3 w-full p-button-outlined"/>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <BlockViewer_1.default header="Call to Action" code={block4} containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8" free>
                <div className="surface-0 text-700 text-center">
                    ...
                    <div className="text-900 font-bold text-5xl mb-3">Join Our Design Community</div>
                    <div className="text-700 text-2xl mb-5">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit numquam eligendi quos.</div>
                    <button_1.Button label="Join Now" icon="pi pi-discord" className="font-bold px-5 py-3 p-button-raised p-button-rounded white-space-nowrap"/>
                </div>
            </BlockViewer_1.default>

            <BlockViewer_1.default header="Banner" code={block5} containerClassName="surface-0 py-8" free>
                <div className="bg-bluegray-900 text-gray-100 p-3 flex justify-content-between lg:justify-content-center align-items-center flex-wrap">
                    <div className="font-bold mr-8">🔥 Hot Deals!</div>
                    <div className="align-items-center hidden lg:flex">
                        <span className="line-height-3">Libero voluptatum atque exercitationem praesentium provident odit.</span>
            ...
            <BlockViewer_1.default header="Page Heading" code={block6} containerClassName="surface-0 px-4 py-5 md:px-6 lg:px-8" free>
                <div className="surface-0">
                    <ul className="list-none p-0 m-0 flex align-items-center font-medium mb-3">
                        <li>
                            <a className="text-500 no-underline line-height-3 cursor-pointer">Application</a>
                    ...
                    <div className="flex align-items-start flex-column lg:justify-content-between lg:flex-row">
                        ...
                        <div className="mt-3 lg:mt-0">
                            <button_1.Button label="Add" className="p-button-outlined mr-2" icon="pi pi-user-plus"/>
            ...
            <BlockViewer_1.default header="Stats" code={block7} containerClassName="px-4 py-5 md:px-6 lg:px-8" free>
                <div className="grid">
                    <div className="col-12 md:col-6 lg:col-3">
                        <div className="surface-0 shadow-2 p-3 border-1 border-50 border-round">
                            <div className="flex justify-content-between mb-3">
            ...
            <BlockViewer_1.default header="Sign-In" code={block8} containerClassName="px-4 py-8 md:px-6 lg:px-8" free>
                <div className="flex align-items-center justify-content-center">
                    <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
                        <div className="text-center mb-5">
                            <img src="/demo/images/blocks/logos/hyper.svg" alt="hyper" height={50} className="mb-3"/>
                        ...
                        <div>
                            ...
                            <inputtext_1.InputText id="email" type="text" placeholder="Email address" className="w-full mb-3"/>

                            <label htmlFor="password" className="block text-900 font-medium mb-2">
                                Password
                            </label>
                            <inputtext_1.InputText id="password" type="password" placeholder="Password" className="w-full mb-3"/>

                            <div className="flex align-items-center justify-content-between mb-6">
                                <div className="flex align-items-center">
                                    <checkbox_1.Checkbox id="rememberme" onChange={(e) => setChecked(e.checked)} checked={checked} className="mr-2"/>
                                    <label htmlFor="rememberme">Remember me</label>
                                </div>
                                <a className="font-medium no-underline ml-2 text-blue-500 text-right cursor-pointer">Forgot your password?</a>
                            </div>

                            <button_1.Button label="Sign In" icon="pi pi-user" className="w-full"/>
                        </div>
                    </div>
                </div>
            </BlockViewer_1.default>

            <BlockViewer_1.default header="Description List" code={block9} containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8" free>
                <div className="surface-0">
                    <div className="font-medium text-3xl text-900 mb-3">Movie Information</div>
                    <div className="text-500 mb-5">Morbi tristique blandit turpis. In viverra ligula id nulla hendrerit rutrum.</div>
                    <ul className="list-none p-0 m-0">
                        <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                            ...
                            <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">Heat</div>
                            <div className="w-6 md:w-2 flex justify-content-end">
                                <button_1.Button label="Edit" icon="pi pi-pencil" className="p-button-text"/>
                            </div>
                        </li>
                        <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                            <div className="text-500 w-6 md:w-2 font-medium">Genre</div>
                            <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">
                                <chip_1.Chip label="Crime" className="mr-2"/>
                                <chip_1.Chip label="Drama" className="mr-2"/>
                                <chip_1.Chip label="Thriller"/>
                            </div>
                            <div className="w-6 md:w-2 flex justify-content-end">
                                <button_1.Button label="Edit" icon="pi pi-pencil" className="p-button-text"/>
                            </div>
            ...
            <BlockViewer_1.default header="Card" code={block10} containerClassName="px-4 py-8 md:px-6 lg:px-8" free>
                <div className="surface-0 p-4 shadow-2 border-round">
                    <div className="text-3xl font-medium text-900 mb-3">Card Title</div>
                    <div className="font-medium text-500 mb-3">Vivamus id nisl interdum, blandit augue sit amet, eleifend mi.</div>
                    <div style={{ height: '150px' }} className="border-2 border-dashed border-300"></div>
