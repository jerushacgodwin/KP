...
const Dashboard = () => {
    ...
    const menu2 = (0, react_1.useRef)(null);
    const [lineOptions, setLineOptions] = (0, react_1.useState)({});
    ...
    return (<div className="grid">
            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    <h5>Recent Sales</h5>
                    <datatable_1.DataTable value={products} rows={5} paginator responsiveLayout="scroll">
                        <column_1.Column header="Image" body={(data) => <img className="shadow-2" src={`/demo/images/product/${data.image}`} alt={data.image} width="50"/>}/>
                        <column_1.Column field="name" header="Name" sortable style={{ width: '35%' }}/>
                        <column_1.Column field="price" header="Price" sortable style={{ width: '35%' }} body={(data) => formatCurrency(data.price)}/>
                        <column_1.Column header="View" style={{ width: '15%' }} body={() => (<>
                                    <button_1.Button icon="pi pi-search" text/>
                                </>)}/>
                ...
                <div className="card">
                    <div className="flex justify-content-between align-items-center mb-5">
                        ...
                        <div>
                            <button_1.Button type="button" icon="pi pi-ellipsis-v" rounded text className="p-button-plain" onClick={(event) => menu1.current?.toggle(event)}/>
            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    ...
                    <chart_1.Chart type="line" data={lineData} options={lineOptions}/>
                </div>
                ...
                <div className="card">
                    <div className="flex align-items-center justify-content-between mb-4">
                        <h5>Notifications</h5>
                        <div>
                            <button_1.Button type="button" icon="pi pi-ellipsis-v" rounded text className="p-button-plain" onClick={(event) => menu2.current?.toggle(event)}/>
                            <menu_1.Menu ref={menu2} popup model={[
            { label: 'Add New', icon: 'pi pi-fw pi-plus' },
            { label: 'Remove', icon: 'pi pi-fw pi-minus' }
        ]}/>
                        </div>
            ...
            background: 'linear-gradient(0deg, rgba(0, 123, 255, 0.5), rgba(0, 123, 255, 0.5)), linear-gradient(92.54deg, #1C80CF 47.88%, #FFFFFF 100.01%)'
                    ...
                    <div className="mt-4 mr-auto md:mt-0 md:mr-0">
                        <link_1.default href="https://blocks.primereact.org" className="p-button font-bold px-5 py-3 p-button-warning p-button-rounded p-button-raised">
                            Get Started
                        </link_1.default>
                    </div>
                </div>
