    ...
    return (<div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
            ...
            background: 'linear-gradient(180deg, rgba(33, 150, 243, 0.4) 10%, rgba(33, 150, 243, 0) 30%)'
                    ...
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        ...
                        <link_1.default href="/" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                        ...
                        <link_1.default href="/" className="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
